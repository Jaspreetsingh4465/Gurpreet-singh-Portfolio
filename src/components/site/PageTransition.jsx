 ...
 * AnimatePresence in the layout. Transform and opacity only, disabled
...
export const PageTransition = ({ children }) => {
  ...
  return (
    <motion.div
      ...
      exit={reduce ? undefined : { opacity: 0, y: -8, transition: { duration: .16 } }}
      transition={{ duration: reduce ? 0 : .28, ease: [0.16, 1, 0.3, 1] }}
    >
      {children}
    </motion.div>
  )

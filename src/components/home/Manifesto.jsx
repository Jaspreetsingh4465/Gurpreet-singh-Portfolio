...
export const Manifesto = () => (
  <section className="bg-ivory">
    <Reveal className="mx-auto max-w-4xl px-6 py-32 text-center md:py-44">
      ...
      <p className="display mt-10 text-[clamp(1.9rem,4vw,3.1rem)] leading-[1.25] text-balance text-charcoal">
        {manifesto.line}
      </p>
      <p className="mx-auto mt-8 max-w-[44ch] text-[18px] leading-[1.7] text-charcoal/60">
        {manifesto.body}
      </p>
    </Reveal>
  </section>

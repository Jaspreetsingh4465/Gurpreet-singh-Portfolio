 ...
 */
export const ArtworkCard = ({ work, index = 0 }) => {
    ...
    <li>
      <Link to={`/work/${work.category}/${work.slug}`} className="group block focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold-light">
        ...
        <Reveal delay={(index % 3) * 0.06 + 0.08}>
          <h3 className="display mt-5 text-[1.3rem] leading-snug text-ivory">{work.title ?? <Gap>Title to be added</Gap>}</h3>
          <p className="mt-1.5 text-[14px] text-ivory/50">

...
export const PageHero = ({ eyebrow, title, lead, sub, tone = "dark" }) => {
  ...
  return (
    <section className={`${light ? "bg-ivory" : "bg-charcoal"} border-b ${light ? "border-charcoal/12" : "border-gold/15"}`}>
      <div className="mx-auto max-w-6xl px-6 pt-24 pb-20 md:pt-32 md:pb-28 lg:px-8">
        {eyebrow && (
          <Reveal>

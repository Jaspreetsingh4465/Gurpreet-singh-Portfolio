...
export const workCategories = [
  ...
  { slug: "historical", title: "Historical work", desc: "Narratives from Punjab’s past, including the period of Maharaja Ranjit Singh, brought into a human context.", photo: { id: "4-canvas", alt: "Painting of animal heads mounted on weathered boards against red" } },
  { slug: "cultural", title: "Cultural art", desc: "Sikh history, Punjabi tradition, architecture and the changing landscape of the region.", photo: { id: "5-stage", alt: "Folk performers on a lit stage" } },
